...
|GET | /data/filmSearch | 
|GET | /data/filmData | 
|POST |/data/users/sendEmail | 
|PATCH | /data/users/me | 

Since the above features relied on external services, I made the decision to test these end points manually due to time constraints
